...
(function($, window, document, undefined) {
    ...
    function ImageCropWidget(element, options) {
        console.log("init ImageCropWidget!")
    ...
    ImageCropWidget.prototype = {
        ...
        init: function() {
            ...
            this.help_text_container = $(this.data_container).find('.help')[0];
        ...
        initialRender: function() {
            ...
            if (this.image_source in window['image_crops']) {
                console.log("get image source from window crops")
                ...
                console.log("need to load image")
                ...
                console.log("IMAE source => " + this.image_source)
        ...
        getSourceImage: function(image_name) {
            ...
            var current_value = $('.field-' + image_name).find(".file-upload a").attr('href')
...
console.log("image crop attached")